...
6. Write a CLAUDE.md for this project using the template below, filling in the creator's details.
   ...
   - `/vicin-studio:analyse-trend` — paste a Threads post URL to get 5 content topic options
   - `/vicin-studio:generate-script` — generate a full script for the chosen topic and save it to this project
   ---
...
8. Confirm all three steps are complete. Show the creator:
   ...
   - What to do next: use /vicin-studio:analyse-trend to find a trend, then /vicin-studio:generate-script to write their first script
